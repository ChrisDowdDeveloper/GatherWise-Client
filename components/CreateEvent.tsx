        ...
        <div className="w-full px-6 md:px-16 pt-10 pb-10 flex flex-col gap-8 items-center">
            <div className="flex flex-col md:flex-row gap-8 w-full max-w-4xl items-start justify-center">
                <div
                    ...
                    className="relative w-full md:w-[360px] h-72 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-100 overflow-hidden"
                >
                    {preview ? (
                        <img
                            src={preview}
                        ...
                        <div className="flex items-center justify-center w-full h-full">
                            <span className="text-base font-medium text-center px-4 text-gray-700">
